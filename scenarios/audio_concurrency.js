window.SCENARIOS['audio_concurrency'] = {
    ...
    steps: {
        'step-1': {
            skill: 'audio',
            title: 'Step 1: Identifying the Problem',
            ...
            choices: [
                {
                    text: 'Action: Open the <strong>Output Log</strong> and filter for audio warnings while reproducing the issue in PIE.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Immediately increase the volume of the gunshot sound.',
                    type: 'wrong',
                ...
                {
                    text: 'Action: Check the Sound Cue asset to see if it has any obvious errors.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Ask QA to file a bug report with more details.',
                    type: 'misguided',
        ...
        'step-1W': {
            ...
            choices: [
                {
                    text: 'Action: Revert the volume change and check the Output Log for audio system warnings.',
                    type: 'correct',
                    feedback: "<p><strong>Optimal Time Logged:</strong> Back on track. The log will reveal the true issue.</p>",
                    next: 'step-2'
                },
                {
                    text: 'Action: Try adjusting the pitch instead of volume.',
                    type: 'wrong',
        ...
        'step-1M': {
            ...
            choices: [
                {
                    text: 'Action: Reproduce the issue yourself in PIE and check the Output Log.',
                    type: 'correct',
        ...
        'step-2': {
            skill: 'audio',
            title: 'Step 2: Understanding Voice Limits',
            ...
            choices: [
                {
                    text: 'Action: Research Sound Concurrency in the UE5 documentation to understand how the audio engine manages simultaneous sounds.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Immediately increase the global voice count in Project Settings > Audio.',
                    type: 'misguided',
                ...
                {
                    text: 'Action: Check if the gunshot Sound Cue has a Concurrency asset assigned.',
                    type: 'partial',
        ...
        'step-2M': {
            ...
            choices: [
                {
                    text: 'Action: Revert the global change and instead use per-sound Concurrency settings to limit only the gunshot sounds.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Keep the high voice count and optimize other systems instead.',
                    type: 'wrong',
        ...
        'step-3': {
            skill: 'audio',
            title: 'Step 3: Creating a Concurrency Asset',
            ...
            choices: [
                {
                    text: 'Action: Right-click in the Content Browser > Audio > Sound Concurrency.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Look for a Concurrency setting inside the Sound Cue editor.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Try to find it in Project Settings > Audio.',
                    type: 'misguided',
                ...
                {
                    text: 'Action: Assume UE5 creates them automatically.',
                    type: 'wrong',
        ...
        'step-4': {
            skill: 'audio',
            title: 'Step 4: Configuring Concurrency Settings',
            ...
            choices: [
                {
                    text: 'Action: Set Max Count to <strong>3-5</strong> to allow a few overlapping shots without overwhelming the audio mix.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Set Max Count to <strong>1</strong> to ensure only one gunshot plays at a time.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Set Max Count to <strong>50</strong> to ensure no sounds are ever cut off.',
                    type: 'misguided',
                ...
                {
                    text: 'Action: Leave Max Count at the default <strong>unlimited</strong>.',
                    type: 'wrong',
        ...
        'step-4M': {
            ...
            choices: [
                {
                    text: 'Action: Reduce Max Count to 3-5 concurrent instances.',
                    type: 'correct',
        ...
        'step-5': {
            ...
            choices: [
                {
                    text: 'Action: Set Resolution Rule to <strong>Stop Oldest</strong> to cut off the oldest gunshot and play the new one.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Set Resolution Rule to <strong>Prevent New</strong> to block new gunshots when the limit is reached.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Set Resolution Rule to <strong>Stop Quietest</strong> to preserve louder sounds.',
                    type: 'misguided',
                ...
                {
                    text: 'Action: Set Resolution Rule to <strong>Stop Farthest</strong> based on distance from listener.',
                    type: 'wrong',
        ...
        'step-5M': {
            ...
            choices: [
                {
                    text: 'Action: Change to Stop Oldest for predictable, responsive behavior.',
                    type: 'correct',
        ...
        'step-6': {
            skill: 'audio',
            title: 'Step 6: Assigning the Concurrency Asset',
            ...
            choices: [
                {
                    text: 'Action: Open the gunshot <strong>Sound Cue</strong>, find the <strong>Sound Concurrency</strong> property, and select <code>SC_Gunshot</code>.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Drag and drop the Concurrency asset onto the Sound Cue in the Content Browser.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Reference the Concurrency asset in the Blueprint that plays the sound.',
                    type: 'misguided',
                ...
                {
                    text: 'Action: Assume it auto-assigns based on naming convention.',
                    type: 'wrong',
        ...
        'step-6M': {
            ...
            choices: [
                {
                    text: 'Action: Open the Sound Cue editor and set the Concurrency property there.',
                    type: 'correct',
        ...
        'step-7': {
            ...
            choices: [
                {
                    text: 'Action: Listen carefully - you should hear up to 4 overlapping gunshots, and the Output Log should show no more voice exhaustion warnings.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Check if ALL sounds are now working perfectly.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Immediately mark the bug as fixed without testing.',
                    type: 'wrong',
                ...
                {
                    text: 'Action: Test only in the editor, not in a packaged build.',
                    type: 'misguided',
        ...
        'step-8': {
            skill: 'audio',
            title: 'Step 8: New Problem - Footsteps Disappearing',
            ...
            choices: [
                {
                    text: 'Action: The gunshots and footsteps are competing for the same voice channels. You need to use <strong>Priority</strong> to ensure footsteps are preserved.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Create a separate Concurrency asset for footsteps.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Reduce the gunshot Max Count to 2 to free up more voices.',
                    type: 'misguided',
        ...
        'step-8W': {
            ...
            choices: [
                {
                    text: 'Action: Revert the volume and instead use Priority settings to protect footsteps.',
                    type: 'correct',
        ...
        'step-8M': {
            ...
            choices: [
                {
                    text: 'Action: Restore gunshot Max Count to 4 and instead use Priority to protect footsteps.',
                    type: 'correct',
        ...
        'step-9': {
            skill: 'audio',
            title: 'Step 9: Setting Sound Priority',
            ...
            choices: [
                {
                    text: 'Action: Set Footsteps to <strong>Priority 1.0</strong> (critical for gameplay) and Gunshots to <strong>Priority 0.5</strong> (less critical).',
                    type: 'correct',
                ...
                {
                    text: 'Action: Set both to Priority 1.0 so both are protected.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Set Gunshots to Priority 1.0 and Footsteps to Priority 0.5.',
                    type: 'wrong',
                ...
                {
                    text: 'Action: Set both to Priority 0.0 to let the engine decide automatically.',
                    type: 'misguided',
        ...
        'step-9W': {
            ...
            choices: [
                {
                    text: 'Action: Swap them - Footsteps Priority 1.0, Gunshots Priority 0.5.',
                    type: 'correct',
        ...
        'step-9M': {
            ...
            choices: [
                {
                    text: 'Action: Set meaningful priorities - Footsteps 1.0, Gunshots 0.5.',
                    type: 'correct',
        ...
        'step-10': {
            skill: 'audio',
            title: 'Step 10: Final Validation',
            ...
            choices: [
                {
                    text: 'Action: Test rapid fire, verify footsteps are audible during combat, check the Output Log for warnings, and have QA validate the fix.',
                    type: 'correct',
                ...
                {
                    text: 'Action: Test only the gunshots and assume footsteps are fine.',
                    type: 'partial',
                ...
                {
                    text: 'Action: Mark the bug as fixed without testing.',
                    type: 'wrong',
                    feedback: "<p><strong>Maximum Time Logged (Ineffective Fix):</strong> Always test your fixes! You might have misconfigured something.</p>",
                    next: 'conclusion'
                },
                {
                    text: 'Action: Only test in the editor, not in a packaged build.',
                    type: 'misguided',
