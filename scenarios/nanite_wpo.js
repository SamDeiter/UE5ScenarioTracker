window.SCENARIOS['nanite_wpo'] = {
    ...
    steps: {
        'step-1': {
            skill: 'rendering',
            title: 'Step 1: Spotting the Symptom',
            ...
            choices: [
                {
                    text: "Action: Use Nanite visualization view modes (e.g., Triangles/Clusters) to inspect the mesh at different distances.",
                    type: 'correct',
                ...
                {
                    text: "Action: Immediately tweak Skylight intensity and color to see if the black goes away.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Swap the material to a plain unlit color test material.",
                    type: 'partial',
                ...
                {
                    text: "Action: Delete the statue mesh from the Content Browser and reimport it from DCC.",
                    type: 'wrong',
        ...
        'step-1W': {
            ...
            choices: [
                {
                    text: "Action: Reset lighting changes and inspect Nanite-specific visualization modes on the mesh.",
                    type: 'correct',
                ...
                {
                    text: "Action: Double down on lighting: rebuild lighting and retune all light sources in the scene.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Toggle post-process volumes on and off hoping the black artifact disappears.",
                    type: 'misguided',
        ...
        'step-1SC': {
            ...
            choices: [
                {
                    text: "Action: Use Source Control to revert the mesh asset to the last known good revision, then refocus on debugging within the engine (view modes and material checks).",
                    type: 'correct',
                ...
                {
                    text: "Action: Leave the new mesh in place and manually fix all broken references across the project.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Accept the broken references as \"good enough for now\" and proceed with debugging on top of this unstable state.",
                    type: 'wrong',
        ...
        'step-2': {
            skill: 'rendering',
            title: 'Step 2: Comparing Near vs Far Behavior',
            ...
            choices: [
                {
                    text: "Action: Open the material used on the statue and inspect the World Position Offset graph and any static switches or per-platform conditionals.",
                    type: 'correct',
                ...
                {
                    text: "Action: Change the mesh mobility from Static to Movable to see if that fixes the black artifact.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Disable all post-process effects in the level (Bloom, AO, Tonemapper).",
                    type: 'wrong',
                ...
                {
                    text: "Action: Convert the mesh to non-Nanite and see if the artifact remains, then switch it back.",
                    type: 'partial',
        ...
        'step-2W': {
            ...
            choices: [
                {
                    text: "Action: Stop tweaking mobility/post-processing and inspect the material's WPO logic and flags.",
                    type: 'correct',
                ...
                {
                    text: "Action: Rebuild lighting again and hope something changes this time.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Temporarily disable the mesh's visibility so you don't have to see the bug.",
                    type: 'misguided',
        ...
        'step-3': {
            skill: 'rendering',
            title: 'Step 3: Material and Usage Flags',
            ...
            choices: [
                {
                    text: "Action: Check the Material Usage flags and ensure 'Used with Nanite' and 'Uses World Position Offset' are correctly enabled when needed.",
                    type: 'correct',
                ...
                {
                    text: "Action: Bypass WPO entirely by hardwiring the WPO output to zero for this material and ship it like that.",
                    type: 'partial',
                ...
                {
                    text: "Action: Enable tessellation and try to use tessellation multiplier to compensate for Nanite simplification.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Randomly delete nodes in the WPO graph until the artifact disappears.",
                    type: 'wrong',
        ...
        'step-3W': {
            ...
            choices: [
                {
                    text: "Action: Disable unnecessary tessellation and focus on how Nanite evaluates WPO in the Static Mesh Editor.",
                    type: 'correct',
                ...
                {
                    text: "Action: Push tessellation even higher to \"force more detail\".",
                    type: 'wrong',
                    feedback: "<p><strong>Maximum Time Logged:</strong> You just burn more performance budget for no benefit in Nanite.</p>",
                    next: 'step-3W'
                },
                {
                    text: "Action: Disable Nanite on this mesh and rely exclusively on tessellation.",
                    type: 'misguided',
        ...
        'step-3SC': {
            ...
            choices: [
                {
                    text: "Action: Use Source Control to revert the material to the last good revision, then look for a Nanite-specific way to handle WPO.",
                    type: 'correct',
                ...
                {
                    text: "Action: Try to manually rebuild the material graph from memory without using Source Control.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Duplicate the broken material and keep both in the project, hoping one of them works.",
                    type: 'wrong',
        ...
        'step-4': {
            skill: 'rendering',
            title: 'Step 4: Static Mesh Editor & Nanite Settings',
            ...
            choices: [
                {
                    text: "Action: Open the Static Mesh Editor for the statue mesh and inspect the Nanite section, including World Position Offset related options.",
                    type: 'correct',
                ...
                {
                    text: "Action: Open Project Settings and start flipping random Rendering and Lumen-related flags.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Create a duplicate level and re-place all actors by hand to see if it still happens.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Disable Nanite completely at the project level.",
                    type: 'partial',
        ...
        'step-4W': {
            ...
            choices: [
                {
                    text: "Action: Stop changing project/level settings and open the Static Mesh Editor to inspect Nanite settings for this specific mesh.",
                    type: 'correct',
                ...
                {
                    text: "Action: Keep flipping random project settings; eventually something might work.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Disable the level from all builds so nobody ever hits this bug.",
                    type: 'misguided',
        ...
        'step-5': {
            skill: 'rendering',
            title: 'Step 5: Configuring Nanite WPO Evaluation',
            ...
            choices: [
                {
                    text: "Action: Set Nanite Settings &gt; World Position Offset &gt; WPO Evaluation Mode to Enabled or Auto.",
                    type: 'correct',
                ...
                {
                    text: "Action: Adjust LOD Settings &gt; Percent Triangles for the mesh.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Reduce the overall Nanite fallback radius so the mesh switches to a non-Nanite fallback sooner.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Disable WPO Evaluation Mode completely to simplify things.",
                    type: 'wrong',
        ...
        'step-5W': {
            ...
            choices: [
                {
                    text: "Action: Enable or set Nanite WPO Evaluation Mode to Auto/Enabled so Nanite actually evaluates WPO when rendering the mesh.",
                    type: 'correct',
                ...
                {
                    text: "Action: Keep tweaking fallback distances and triangle percentages in small increments.",
                    type: 'misguided',
                    feedback: "<p><strong>Extended Time Logged:</strong> You're micro-tuning knobs that aren't addressing the root cause.</p>",
                    next: 'step-5W'
                },
                {
                    text: "Action: Disable Nanite for the entire project to avoid this category of problem forever.",
                    type: 'wrong',
        ...
        'step-6': {
            skill: 'rendering',
            title: 'Step 6: In-Game Verification',
            ...
            choices: [
                {
                    text: "Action: Enter Play-In-Editor (PIE) or Simulate, move around the statue at different distances, and monitor the mesh's appearance and performance stats.",
                    type: 'correct',
                ...
                {
                    text: "Action: Assume the fix works because it looks good in the viewport and immediately mark the task as done.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Disable real-time rendering in the viewport and call it \"verified\" because it looks fine in a single frame.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Only test in a tiny corner of the level where the bug never really showed up.",
                    type: 'partial',
        ...
        'step-6W': {
            ...
            choices: [
                {
                    text: "Action: Run the level in PIE/Simulate, move around the scene, and observe the statue's shading at varying distances.",
                    type: 'correct',
                    feedback: "<p><strong>Optimal Time Logged:</strong> Proper testing confirms the fix in gameplay conditions.</p>",
                    next: 'step-7'
                },
                {
                    text: "Action: Wait for QA to report if it's still broken instead of testing yourself.",
                    type: 'misguided',
                    feedback: "<p><strong>Extended Time Logged:</strong> You're offloading basic verification onto QA, slowing the feedback loop.</p>",
                    next: 'step-6W'
                },
                {
                    text: "Action: Package a build without testing and hope for the best.",
                    type: 'wrong',
        ...
        'step-7': {
            skill: 'rendering',
            title: 'Step 7: Checking Interaction with Lumen',
            ...
            choices: [
                {
                    text: "Action: On the mesh component, verify that 'Rendering &gt; Support Global Illumination' is enabled (where applicable).",
                    type: 'correct',
                ...
                {
                    text: "Action: Focus only on 'Cast Static Shadow' and rebuild static lighting.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Turn off all GI to guarantee the bug never appears again.",
                    type: 'wrong',
                ...
                {
                    text: "Action: Crank up emissive on the material to fake lighting instead of using proper GI.",
                    type: 'partial',
        ...
        'step-7W': {
            ...
            choices: [
                {
                    text: "Action: Re-enable appropriate GI settings and ensure 'Support Global Illumination' is correctly set on the Nanite mesh component.",
                    type: 'correct',
                ...
                {
                    text: "Action: Ignore Lumen entirely and assume lighting is \"good enough\".",
                    type: 'misguided',
                ...
                {
                    text: "Action: Lower overall scene exposure to hide any subtle issues.",
                    type: 'wrong',
        ...
        'step-8': {
            skill: 'rendering',
            title: 'Step 8: Cross-Asset Regression Check',
            ...
            choices: [
                {
                    text: "Action: Identify other meshes using the same material or similar Nanite WPO configuration and test them in representative levels.",
                    type: 'correct',
                ...
                {
                    text: "Action: Assume no other assets are affected and skip regression testing.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Mass-apply random Nanite setting changes to all meshes in the project so they \"match\".",
                    type: 'wrong',
                ...
                {
                    text: "Action: Only test the statue in an empty test map and ignore real production levels.",
                    type: 'partial',
        ...
        'step-8SC': {
            ...
            choices: [
                {
                    text: "Action: Use Source Control to revert the wide Nanite setting changes, then limit your testing to a focused set of related assets.",
                    type: 'correct',
                ...
                {
                    text: "Action: Try to manually remember and revert the dozens of changes you made without using Source Control.",
                    type: 'misguided',
                    feedback: "<p><strong>Extended Time Logged:</strong> This is slow and error-prone; you'll likely miss something.</p>",
                    next: 'step-8SC'
                },
                {
                    text: "Action: Accept the new broken behavior as the \"new normal\" and move on.",
                    type: 'wrong',
        ...
        'step-9': {
            skill: 'rendering',
            title: 'Step 9: Documenting the Root Cause',
            ...
            choices: [
                {
                    text: "Action: Document the bug, root cause, and fix (including screenshots of Nanite WPO settings) in your team's knowledge base or issue tracker.",
                    type: 'correct',
                ...
                {
                    text: "Action: Keep the knowledge in your head and move on to the next task.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Just ping a teammate in chat with a quick summary and no persistent record.",
                    type: 'partial',
                ...
                {
                    text: "Action: Close the ticket with a vague note like \"engine bug fixed\" and no details about what actually changed.",
                    type: 'wrong',
        ...
        'step-9W': {
            ...
            choices: [
                {
                    text: "Action: Reopen or update the ticket with a clear description, root cause explanation, and the specific Nanite WPO setting changes you made.",
                    type: 'correct',
                ...
                {
                    text: "Action: Leave the vague ticket as-is and hope nobody ever needs it.",
                    type: 'misguided',
                    feedback: "<p><strong>Extended Time Logged:</strong> You're setting up future teammates (and your future self) for frustration.</p>",
                    next: 'step-9W'
                },
                {
                    text: "Action: Create a new duplicate ticket with slightly different wording instead of fixing the original.",
                    type: 'wrong',
        ...
        'step-10': {
            skill: 'rendering',
            title: 'Step 10: Final Verification & Handoff',
            ...
            choices: [
                {
                    text: "Action: Create a small test map or level viewport bookmark that reproduces the original bug scenario and clearly shows the fixed behavior for QA and future debugging.",
                    type: 'correct',
                ...
                {
                    text: "Action: Delete all test assets and levels so the project stays \"clean\".",
                    type: 'wrong',
                ...
                {
                    text: "Action: Rely on QA to \"figure it out\" without giving them any tailored test level or clear reproduction steps.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Add a short section to your existing regression test map instead of a dedicated new level, then note that in the ticket.",
                    type: 'partial',
        ...
        'step-10W': {
            ...
            choices: [
                {
                    text: "Action: Restore or recreate a focused test scenario (small test map or clear bookmark) and link it in the ticket so QA and future devs can easily verify the behavior.",
                    type: 'correct',
                ...
                {
                    text: "Action: Ask QA to create the test map for you instead of doing it yourself.",
                    type: 'misguided',
                ...
                {
                    text: "Action: Do nothing further; hope the existing levels are \"good enough\" for regression testing.",
                    type: 'wrong',
