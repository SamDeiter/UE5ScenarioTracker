    ...
    steps:
      {
        ...
        'conclusion'},{text:'Delete the local save game data.',type:'partial',feedback:"<p><strong>Standard Time Logged:</strong> Good habit, but not the priority after a successful package.</p>",next:
        'step-inv-1': {
            skill: 'world',
            title: 'Investigation 1: Confirming World Partition Activation',
            prompt: "<p>Before profiling, you must confirm the map is correctly using World Partition. What is the fastest way to verify that World Partition is active and the map is partitioned?</p>",
        ...
        'conclusion'},{text:'Restart the editor to ensure all temporary files are cleared.',type:'misguided',feedback:"<p><strong>Extended Time Logged (Investigation):</strong> Unnecessary after a clean cook.</p>",next:
        'step-inv-1': {
            skill: 'world',
            title: 'Investigation 1: Confirming World Partition Activation',
            prompt: "<p>Before profiling, you must confirm the map is correctly using World Partition. What is the fastest way to verify that World Partition is active and the map is partitioned?</p>",
        ...
        'conclusion'},{text:'Start working on the next ticket immediately.',type:'wrong',feedback:"<p><strong>Maximum Time Logged (Ineffective Fix):</strong> Documentation and committing the current work is the immediate priority.</p>",next:
        'step-inv-1': {
            skill: 'world',
            title: 'Investigation 1: Confirming World Partition Activation',
            prompt: "<p>Before profiling, you must confirm the map is correctly using World Partition. What is the fastest way to verify that World Partition is active and the map is partitioned?</p>",
